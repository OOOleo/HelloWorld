...
public class Request {
    ...
    public static class Builder{
        ...
        public Builder newRequest(Request request) {
            ...
            if (StrUtil.isNotEmpty(request.groupLeaderInfo)) {
                this.groupLeaderInfo = request.groupLeaderInfo;
            }

            if (StrUtil.isNotEmpty(request.managerInfo)) {
                this.managerInfo = request.managerInfo;
            }

            if (StrUtil.isNotEmpty(request.departmentHeaderInfo)) {
                this.departmentHeaderInfo = request.departmentHeaderInfo;
            }

            if (StrUtil.isNotEmpty(request.customInfo)) {
